  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Comprender los ajustes razonables a realizar y las barreras que pueden presentarse en un plan de acompañamiento familiar con PcD, mediante la identificación de las distintas condiciones de discapacidad.
